...
extern "C" ::Result __nx_nv_create_tmem(TransferMemory *t, u32 *out_size, Permission perm) {
    *out_size = sizeof(alefbet::pctrl::srv::g_nv_transfer_memory);
    return tmemCreateFromMemory(t, alefbet::pctrl::srv::g_nv_transfer_memory, sizeof(alefbet::pctrl::srv::g_nv_transfer_memory), perm);
}
...
namespace alefbet::pctrl::srv {
    ...
    Result GuiController::PrepareScreenForDrawing() {
        ...
        /* Setup the layer. */
        {
            ...
            R_TRY(viSetLayerZ(std::addressof(m_layer), PctrlLayerZ));
