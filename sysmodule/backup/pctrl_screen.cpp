...
namespace alefbet::pctrl::srv {
    ...
    namespace {
        ...
        constexpr u32 PctrlScreenWidthAlignedBytes = ams::util::AlignUp(PctrlScreenWidth * PctrlScreenBpp, 64);
        ...
        constexpr size_t FrameBufferRequiredSizeBytes       = PctrlScreenWidthAlignedBytes * ams::util::AlignUp(PctrlScreenHeight, 128);
        constexpr size_t FrameBufferRequiredSizePageAligned = ams::util::AlignUp(FrameBufferRequiredSizeBytes, ams::os::MemoryPageSize);
        constexpr size_t FrameBufferRequiredSizeHeapAligned = ams::util::AlignUp(FrameBufferRequiredSizeBytes, ams::os::MemoryHeapUnitSize);
